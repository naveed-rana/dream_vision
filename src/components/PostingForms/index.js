      ...
      case 1:
        return (
          <Grid container spacing={8}>
            <Grid item xs={12} md={12} className="paddingTop">
              <Typography variant="caption" align="center">
                Please add correct price and specfications of products for
                better experience and sell.
              </Typography>
              <TextField
                InputProps={{
                  startAdornment: (
          ...
          <div>
            <Grid container spacing={8}>
              <Grid item xs={12} md={12}>
                <Typography variant="caption" align="center">
                  Please Add Your Products Images That Best Describe Your
                  Product, Select at leaset one image!
                </Typography>
              </Grid>
      ...
      <div className={classes.root}>
        ...
        {activeStep === steps.length && (
          <Paper square elevation={0} className={classes.resetContainer}>
            <Typography>
              All steps completed - you&quot;re finished! if you are done submit
              the form otherwise you can reset the forms.
            </Typography>
            <Button
              variant="outlined"
              color="primary"
...
export default withRouter(
  compose(
    connect(
      mapStateToProps,
      { startAdsPosting, clearAdsPosting }
    ),
    withStyles(styles)
