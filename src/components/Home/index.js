            ...
            <Paper className="shadownone" elevation={10}>
              ...
              <Grid container spacing={8} className="marginTop">
                ...
                <Grid
                  ...
                  md={3}
                  className="pointer"
                  onClick={() => this.onClickHandler("mobiles")}
                  align="center"
                >
                ...
                <Grid
                  ...
                  md={3}
                  className="pointer"
                  onClick={() => this.onClickHandler("vehicals")}
                  align="center"
                >
                  <img src={require("../resource/images/car.JPG")} alt="" />
                  <Typography variant="body2">Vehicals</Typography>
                </Grid>
                <Grid
                  item
                  xs={6}
                  md={3}
                  className="pointer"
                  onClick={() => this.onClickHandler("animals")}
                  align="center"
                >
                  <img src={require("../resource/images/animals.JPG")} alt="" />
                  <Typography variant="body2">Animals</Typography>
                </Grid>
                <Grid
                  item
                  xs={6}
                  md={3}
                  className="pointer marginTop"
                  onClick={() => this.onClickHandler("furniture")}
                  align="center"
                >
                  <img
                    src={require("../resource/images/furniture.JPG")}
                    alt=""
                  />
                ...
                <Grid
                  ...
                  md={3}
                  className="pointer marginTop"
                  onClick={() => this.onClickHandler("laptops")}
                  align="center"
                >
                ...
                <Grid
                  ...
                  md={3}
                  className="pointer marginTop"
                  onClick={() => this.onClickHandler("books")}
                  align="center"
                >
                ...
                <Grid
                  ...
                  md={3}
                  className="pointer marginTop"
                  onClick={() => this.onClickHandler("property")}
                  align="center"
                >
                  <img
                    src={require("../resource/images/property1JPG.JPG")}
                    alt=""
                  />
