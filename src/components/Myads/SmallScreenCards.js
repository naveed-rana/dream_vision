    ...
    return (
      <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Confirmations! after delete your ads permanently delete from your
              accounts,Are you sure you want to delete?
            </DialogContentText>
          </DialogContent>
          <DialogActions>
        ...
        <Card className={classes.card}>
          <CardHeader
            ...
            subheader={`Category:${this.props.ad.category}. ${moment(
              this.props.ad.timestamp
            ).format("ll")}`}
          />
          <CardMedia
